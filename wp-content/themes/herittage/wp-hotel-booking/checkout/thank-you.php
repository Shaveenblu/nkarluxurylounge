...
<?php if ( $booking_id && get_post_type( $booking_id ) == 'hb_booking' ) {
	...
	if ( $booking->booking_key === $key ) {
		...
		<div class="hb-message message">
			<div class="hb-message-content">
				<?php echo esc_html__( 'Thank you! Your booking has been placed. We will contact you to confirm about the booking soon.', 'herittage' ); ?>
			</div>
		</div>

		<div id="booking-details">
			<div class="booking-data">
				<h3 class="booking-data-number"><?php echo sprintf( esc_html__( 'Booking %s', 'herittage' ), hb_format_order_number( $booking_id ) ); ?></h3>
				<div class="booking-date">
					<?php echo sprintf( esc_html__( 'Date %s', 'herittage' ), get_the_date( '', $booking_id ) ); ?>
				</div>
			</div>
		</div>
		...
		<div id="booking-items">
			...
			<h3><?php echo esc_html__( 'Booking Items', 'herittage' ); ?></h3>

			<table cellpadding="0" cellspacing="0" class="booking_item_table">
				<thead>
				<tr>
					<th><?php esc_html_e( 'Item', 'herittage' ); ?></th>
					<th><?php esc_html_e( 'Check in - Checkout', 'herittage' ) ?></th>
					<th><?php esc_html_e( 'Night', 'herittage' ); ?></th>
					<th><?php esc_html_e( 'Qty', 'herittage' ); ?></th>
					<th><?php esc_html_e( 'Total', 'herittage' ); ?></th>
				</tr>
				</thead>
				<tbody>
				...
				<tr>
					<td colspan="4"><?php esc_html_e( 'Grand Total', 'herittage' ) ?></td>
					<td>
				...
				if ( floatval( hb_booking_total( $booking->id ) ) !== floatval( $advance_payment ) ) { ?>
					<tr>
						<td colspan="4"><?php esc_html_e( 'Advance Payment', 'herittage' ) ?></td>
						<td>
		...
		<div id="booking-customer">
			...
			<div class="customer-details">
				<ul class="hb-form-table">
					...
					<li>
						<label for="_hb_customer_title"><?php echo esc_html__( 'Title:', 'herittage' ); ?></label>
						<?php echo esc_html( hb_get_title_by_slug( $booking->customer_title ) ); ?>
					</li>

					<li>
						<label for="_hb_customer_first_name"><?php echo esc_html__( 'First Name:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_first_name ); ?>
					</li>

					<li>
						<label for="_hb_customer_last_name"><?php echo esc_html__( 'Last Name:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_last_name ); ?>
					</li>

					<li>
						<label for="_hb_customer_address"><?php echo esc_html__( 'Address:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_address ); ?>
					</li>

					<li>
						<label for="_hb_customer_city"><?php echo esc_html__( 'City:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_city ); ?>
					</li>

					<li>
						<label for="_hb_customer_state"><?php echo esc_html__( 'State:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_state ); ?>
					</li>

					<li>
						<label for="_hb_customer_postal_code"><?php echo esc_html__( 'Postal Code:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_postal_code ); ?>
					</li>

					<li>
						<label for="_hb_customer_country"><?php echo esc_html__( 'Country:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_country ); ?>
					</li>

					<li>
						<label for="_hb_customer_phone"><?php echo esc_html__( 'Phone:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_phone ); ?>
					</li>

					<li>
						<label for="_hb_customer_email"><?php echo esc_html__( 'Email:', 'herittage' ); ?></label>
						<?php echo esc_html( $booking->customer_email ); ?>
					</li>

					<li>
						<label for="_hb_customer_fax"><?php echo esc_html__( 'Fax:', 'herittage' ); ?></label>
			...
			<div class="booking-notes">
				<label for="_hb_customer_notes"><?php echo esc_html__( 'Booking Notes:', 'herittage' ); ?></label>
			...
			<?php if ( ( ! $booking->method || $booking->method == 'offline-payment' ) ) {
				...
				if ( isset( $option['instruction'] ) && $option['instruction'] ) {
					?>
					<div id="instruction">
						<h3><?php echo esc_html__( 'Payment Instruction', 'herittage' ); ?></h3>
	...
	<?php } else { ?>
		<div class="hb-message error"><p><?php echo esc_html__( 'Booking invalid', 'herittage' ) ?></p></div>
	<?php }
} else { ?>
	<div class="hb-message error"><p><?php echo esc_html__( 'Booking invalid', 'herittage' ) ?></p></div>
<?php } ?>

...
if( ! function_exists( 'herittage_shop_woo_loop_product_content' ) ) {

	function herittage_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				herittage_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('herittage_woo_loop_product_content_content', 'content');
					remove_all_actions('herittage_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'herittage_shop_woo_loop_product_content', 10 );

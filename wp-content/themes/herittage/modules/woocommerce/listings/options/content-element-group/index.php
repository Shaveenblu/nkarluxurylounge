...
if( !class_exists( 'Herittage_Woo_Listing_Option_Content_Element_Group' ) ) {

    class Herittage_Woo_Listing_Option_Content_Element_Group extends Herittage_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'herittage_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('herittage_woo_listing_option_content_element_group') ) {
	function herittage_woo_listing_option_content_element_group() {
		return Herittage_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

herittage_woo_listing_option_content_element_group();
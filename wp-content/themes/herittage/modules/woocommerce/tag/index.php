...
if( !class_exists( 'Herittage_Woo_Listing_Tag' ) ) {

    class Herittage_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'herittage_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('herittage_woo_listing_tag') ) {
	function herittage_woo_listing_tag() {
		return Herittage_Woo_Listing_Tag::instance();
	}
}

herittage_woo_listing_tag();
...
if( !class_exists( 'Herittage_Woo_Listing_Shop' ) ) {

    class Herittage_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'herittage_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('herittage_woo_listing_shop') ) {
	function herittage_woo_listing_shop() {
		return Herittage_Woo_Listing_Shop::instance();
	}
}

herittage_woo_listing_shop();
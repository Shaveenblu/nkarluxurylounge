...
if( !class_exists( 'Herittage_Woo_Others' ) ) {

    class Herittage_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'herittage_woo_others_settings', $this->settings );
...
if( !function_exists('herittage_woo_others') ) {
	function herittage_woo_others() {
		return Herittage_Woo_Others::instance();
	}
}

herittage_woo_others();
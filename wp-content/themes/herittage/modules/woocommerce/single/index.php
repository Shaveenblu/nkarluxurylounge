...
if( !class_exists( 'Herittage_Woo_Single_core' ) ) {

    class Herittage_Woo_Single_core {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'herittage_after_woo_css', array ( $this, 'after_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( herittage_is_file_in_theme( __FILE__ ) ) {
                    return HERITTAGE_MODULE_DIR . '/woocommerce/single/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( herittage_is_file_in_theme( __FILE__ ) ) {
                    return HERITTAGE_MODULE_URI . '/woocommerce/single/';
                } else {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'herittage_woo_single_page_settings', $this->settings );
        ...
        */
            function load_modules() {
                ...
                include_once HERITTAGE_MODULE_DIR. '/woocommerce/single/includes/template.php';
                include_once HERITTAGE_MODULE_DIR. '/woocommerce/single/includes/labels.php';
            ...
            function load_custom_modules() {
                ...
                if( is_array( $custom_modules ) && !empty( $custom_modules ) ) {
                    foreach( $custom_modules as $custom_module ) {
                        ...
                        if( $file_path = herittage_woo_locate_file( $custom_module ) ) {
        ...
        */
            function after_woo_css() {
                ...
                if( is_product() ) {
                    wp_enqueue_style('herittage-woo-single-common', $this->module_dir_url() . 'assets/css/common.css');
                }
...
if( !function_exists('herittage_woo_single_core') ) {
	function herittage_woo_single_core() {
        $reflection = new ReflectionClass('Herittage_Woo_Single_core');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Herittage_Woo_Single_core::instance();
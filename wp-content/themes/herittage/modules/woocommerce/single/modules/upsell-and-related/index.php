...
if( !class_exists( 'Herittage_Shop_Single_Module_Upsell_Related' ) ) {

    class Herittage_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( herittage_is_file_in_theme( __FILE__ ) ) {
                    return HERITTAGE_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( herittage_is_file_in_theme( __FILE__ ) ) {
                    return HERITTAGE_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'herittage_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('herittage_shop_single_module_upsell_related') ) {
	function herittage_shop_single_module_upsell_related() {
		return Herittage_Shop_Single_Module_Upsell_Related::instance();
	}
}

herittage_shop_single_module_upsell_related();
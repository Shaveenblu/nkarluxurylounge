<?php
	...
	<?php
	    do_action( 'herittage_before_single_post_content_wrap' );
	    ...
	    if( have_posts() ) {
	        while( have_posts() ) {
	            ...
	            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	                <?php echo herittage_get_template_part( 'post', 'templates/'.$post_style.'/post', '', $template_args ); ?>
	            </article><!-- #post-<?php the_ID(); ?> --><?php
	        }
	    }

	    do_action( 'herittage_after_single_post_content_wrap', $template_args['ID'] );?>
	</section><!-- Primary End -->

...
<div class="single-entry-likes-views">
	<div class="wdt-like-views">
        <div class="likes herittage_like_btn">
        ...
        <div class="views">
            <i class="wdticon-eye"></i>
            	<span><?php
					...
					update_post_meta( $post_ID, '_herittage_post_settings', $post_meta );
					echo herittage_html_output($v);
            	?></span>
        </div>
	</div>
